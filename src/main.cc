...
namespace {
    ...
    void print_usage () {
        ...
        cout << " -n --nether       Use nether image generation algorythm "
             ...
             << endl;
        cout
            << " -o --out DIR      specify output directory. (default: current "
               "directory)"
            << endl;
    ...
    option generate_command_options[] = {{"jobs", required_argument, 0, 'j'},
    ...
    option server_command_options[] = {{"daemon", no_argument, 0, 'd'},
