...
namespace pixel_terrain::nbt {
    namespace {
        ...
        auto parse_array_index(iterator first, iterator last,
            ...
            *spec =
                nbt_path::pathspec(idx, nbt_path::pathspec::container::ARRAY);
        ...
        auto parse_list_index(iterator first, iterator last,
            ...
            *spec =
                nbt_path::pathspec(idx, nbt_path::pathspec::container::LIST);
        ...
        auto parse_path_compoent(iterator first, iterator last,
            ...
            if (*first == '/') {
                iterator itr =
                    parse_tag_compound_component(first, last, spec, ok);
                if (*ok) {
                    return itr;
                }
            } else if (*first == '[') {
